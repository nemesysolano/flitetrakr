...
public class QueryTest {
	...
	public void testConnectionsWithMinimumStops() throws ParseException { //What is the price of the connection ...? 
		...
		Assert.assertEquals(1, query1.connectionsWithExactStops(1, "NUE", "LHR"));
		Assert.assertEquals(6, query2.connectionsWithMinimumStops(3, "a", "e"));
		Assert.assertEquals(4, query2.connectionsWithMinimumStops(2, "x", "e"));
